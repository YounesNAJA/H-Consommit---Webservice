...
public class ResultatMoisElec implements Serializable{
	...
	public ResultatMoisElec(long quantite, double prix, Reponse reponse) {
		super();
	...
	public ResultatMoisElec(long quantite, double prix,String compareMois, Reponse reponse) {
		super();
		this.quantite = quantite;
		this.prix = prix;
